...
interface Ireturn {
  removeSync: () => void;
  (config?: Partial<Iconfig>): Promise<Configuration>;
}

const fn = (async (config?: Partial<Iconfig>): Promise<Configuration> => {
...
fn.removeSync = temporary.removeSync.bind(temporary);
